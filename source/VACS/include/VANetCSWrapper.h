...
extern "C"
{
	...
	VACS_API bool NativeGetSoundReceiverMuted( CUnmanagedVANetClient*, int iID );
	VACS_API void NativeSetSoundReceiverMuted( CUnmanagedVANetClient*, int iID, bool bMuted );
	...
	VACS_API void NativeGetSoundReceiverRealWorldPositionOrientationVU( CUnmanagedVANetClient*, int iID, double& px, double& py, double& pz, double& vx, double& vy,
	                                                                    double& vz, double& ux, double& uy, double& uz );
	VACS_API void NativeSetSoundReceiverRealWorldPositionOrientationVU( CUnmanagedVANetClient*, int iID, double px, double py, double pz, double vx, double vy, double vz,
	                                                                    double ux, double uy, double uz );
	VACS_API void NativeGetSoundReceiverRealWorldPose( CUnmanagedVANetClient*, int iID, double& px, double& py, double& pz, double& ox, double& oy, double& oz,
	                                                   double& wo );
	...
	VACS_API void NativeUpdateGenericPath( CUnmanagedVANetClient* pClient, const char* pcRendererID, int iSourceID, int iReceiverID, int iChannel, float fDelaySeconds,
	...
	VACS_API void NativeUpdateGenericPathDelay( CUnmanagedVANetClient* pClient, const char* pcRendererID, int iSourceID, int iReceiverID, float fDelaySeconds );
