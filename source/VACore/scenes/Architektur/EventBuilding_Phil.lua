--[[
	...
	Szene: 			EventBuilding (Architektur) Phil
...
Audiofile = DataPath.."\\Audiofiles\\gershwin-mono.wav"
c = VACore()
--c:Reset()
GeoFile = "$(RavenDataBasePath)/Models/EventBuilding/Raven_Phil.ac"
...
c:SetListenerPositionOrientationVU(L, 175,9,75, 0,0,-1, 0,1,0)
c:SetListenerHRIRDataset(L, H);

-- Schallquellen
S = c:CreateSoundSource("Trompete", "DS, ER, DD, DIR, DP")
c:SetSoundSourcePositionOrientationVU(S, 180,7.2,76.5, 0,0,1, 0,1,0)
