...
public:
	...
	CVAReceiverState* RequestSoundReceiverState( );
	...
	CVASoundReceiverDesc* CreateSoundReceiverDesc( int iListenerID );
	void DeleteSoundReceiverDesc( int iListenerID );
	CVASoundReceiverDesc* GetSoundReceiverDesc( int iListenerID ) const;
	...
	std::string GetSoundReceiverName( int iListenerID ) const;
	void SetSoundReceiverName( int iListenerID, const std::string& sName );
...
private:
	...
	int m_iIDCounterSoundReceivers; //!< ID-Counter: Hörer
	...
	IVAObjectPool* m_pPoolSoundSourceStates;   //!< State-Pool: Schallquellen-Zustände
	IVAObjectPool* m_pPoolSoundReceiverStates; //!< State-Pool: Hörer-Zustände
	...
	typedef std::map<int, CVASoundReceiverDesc*> SoundReceiverDescMap;
	SoundReceiverDescMap m_mListenerDesc;
