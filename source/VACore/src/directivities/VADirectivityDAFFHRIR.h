...
public:
	...
	const DAFFMetadata* GetMetadataByIndex( const int iIndex ) const;

	void GetHRIR( ITASampleFrame* psfDest, const float fAzimuthDeg, const float fElevationDeg, const float fDistanceMeters, int* piIndex = nullptr,
