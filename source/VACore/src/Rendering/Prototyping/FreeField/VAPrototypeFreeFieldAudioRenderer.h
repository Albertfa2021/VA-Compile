 ...
 *
 */
class CVAPrototypeFreeFieldAudioRenderer
...
protected:
	...
	public:
		...
		CVAPFFSource( const Config& oConf_ ) : oConf( oConf_ ) { };
	...
	public:
		...
		CVAPFFReceiver( CVACoreImpl* pCore, const Config& oConf ) : pCore( pCore ), oConf( oConf ) { };
