 ...
 *
 */
class CVAAmbisonicsFreeFieldAudioRenderer
...
protected:
	...
	public:
		...
		CVAAFFSource( const Config& oConf_ ) : oConf( oConf_ ) { };
		...
		double GetCreationTimestamp( ) const { return m_dCreationTimeStamp; };
	...
	public:
		...
		inline CVAAFFListener( CVACoreImpl* pCore, const Config& oConf ) : pCore( pCore ), oConf( oConf ) { };
