 ...
 *
 */
class CVABinauralArtificialReverbAudioRenderer
...
private:
	...
	mutable std::mutex m_mxFilterDesign;
	...
	EVDLAlgorithm m_iDefaultVDLSwitchingAlgorithm; //!< Switching algorithm of variable delay lines
