 ...
 *
 */
class CVABinauralFreeFieldAudioRenderer
...
protected:
	...
	public:
		...
		inline CVABFFSource( const Config& oConf_ ) : oConf( oConf_ ) { };
	...
	public:
		...
		inline CVABFFReceiver( CVACoreImpl* pCore, const Config& oConf ) : pCore( pCore ), oConf( oConf ) { };
