...
public:
	...
	inline std::string GetClassIdentifier( ) const { return m_sClassIdentifier; };

	inline IVAAudioRenderer* Create( const CVAAudioRendererInitParams& oParams ) { return new TRenderer( oParams ); };
