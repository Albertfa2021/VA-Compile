...
{
public:
	inline CVAAudioReproductionModuleDefaultFactory( const std::string& sClassIdentifier ) : m_sClassIdentifier( sClassIdentifier ) { };

	inline std::string GetClassIdentifier( ) const { return this->m_sClassIdentifier; };

	inline IVAAudioReproduction* Create( const CVAAudioReproductionInitParams& oParams ) { return new TReproduction( oParams ); };
