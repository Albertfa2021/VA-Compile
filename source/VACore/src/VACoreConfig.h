...
public:
	...
	double dDefaultAmplitudeCalibration; //!< Defines the conversion between physical pressure and digital or electrical amplitudes ( usually 1.0 -> 94 dB SPL re 20uPa @
	                                     //!< 1m )
