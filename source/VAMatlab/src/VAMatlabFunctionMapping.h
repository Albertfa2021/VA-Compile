...
public:
	...
	inline FunctionInputArgument( const std::string& sFunctionName, const std::string& sArgName, const std::string& sArgType, const std::string& sArgDesc,
	                              bool bArgOptional, const std::string& sArgDefaultValue )
	    : sName( sArgName )
	    , sType( sArgType )
	    , sDesc( sArgDesc )
...
public:
	...
	FunctionMapping( const std::string& sFunctionName, CommandFunction* pFunctionAddr, bool bPublicFunc, const std::string& sFunctionDesc,
...
#define REGISTER_PUBLIC_FUNCTION( NAME, DESC, DOC )                          \
	void NAME( int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[] ); \
	FunctionMapping g_oFuncMapping_##NAME( #NAME, &NAME, true, DESC, DOC )

#define REGISTER_PRIVATE_FUNCTION( NAME )                                    \
	void NAME( int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[] ); \
	FunctionMapping g_oFuncMapping_##NAME( #NAME, &NAME, false, "", "" )

#define DECLARE_FUNCTION_REQUIRED_INARG( FUNCNAME, ARGNAME, ARGTYPE, ARGDESC ) \
	FunctionInputArgument g_oFuncInArg_##FUNCNAME##_##ARGNAME##( #FUNCNAME, #ARGNAME, ARGTYPE, ARGDESC, false, "" )
#define DECLARE_FUNCTION_OPTIONAL_INARG( FUNCNAME, ARGNAME, ARGTYPE, ARGDESC, ARGDEF ) \
	FunctionInputArgument g_oFuncInArg_##FUNCNAME##_##ARGNAME##( #FUNCNAME, #ARGNAME, ARGTYPE, ARGDESC, true, ARGDEF )

#define DECLARE_FUNCTION_OUTARG( FUNCNAME, ARGNAME, ARGTYPE, ARGDESC ) \
	FunctionOutputArgument g_oFuncOutArg_##FUNCNAME##_##ARGNAME##( #FUNCNAME, #ARGNAME, ARGTYPE, ARGDESC )
